...
#define FLASH_SPI_SCK_PIN                   GPIO_Pin_7                  /* PA.05 */
#define FLASH_SPI_SCK_GPIO_PORT             GPIOF                       /* GPIOA */
...
#define FLASH_SPI_MISO_PIN                  GPIO_Pin_8                  /* PA.06 */
#define FLASH_SPI_MISO_GPIO_PORT            GPIOF                       /* GPIOA */
...
#define FLASH_SPI_MOSI_PIN                  GPIO_Pin_9                  /* PA.07 */
#define FLASH_SPI_MOSI_GPIO_PORT            GPIOF                       /* GPIOA */
...
#define FLASH_CS_PIN                        GPIO_Pin_6                 /* PA.04 */
#define FLASH_CS_GPIO_PORT                  GPIOF                       /* GPIOA */
